...
export default function Home() {
  const [showFriends, setShowFriends] = useState(false); // State to manage dropdown visibility
  ...
  return (
    <div className="min-h-screen p-6">
      {/* Main Content */}
      <div className="container mx-auto mt-6 grid grid-cols-1 lg:grid-cols-[20%_65%_15%] gap-2">
        {/* Left Column - Community or Rooms */}
        <div className="bg-white p-6 rounded-lg shadow-md">
          <h2 className="text-xl font-bold mb-4">Community / Rooms</h2>
        ...
        <div className="bg-white p-6 rounded-lg shadow-md">
          ...
          <div
            ...
            onClick={toggleFriendsDropdown} // Toggle dropdown on click
          >
            <h2 className="text-xl font-bold mb-4">Friends</h2>
          </div>

          {/* Friends List (Conditionally Rendered) */}
          {showFriends && (
            <div className="space-y-4">
              {/* Friend Cards */}
              <div className="flex items-center space-x-4">
